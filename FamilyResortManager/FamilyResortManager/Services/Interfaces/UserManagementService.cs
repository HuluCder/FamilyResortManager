...
using FamilyResortManager.Data.Identity; // ⬅ добавлено
...
namespace FamilyResortManager.Services.Implementation
{
    ...
    {
        private readonly UserManager<ApplicationUser> _userManager; // ⬅ заменено
        private readonly RoleManager<IdentityRole> _roleManager;

        public UserManagementService(
            UserManager<ApplicationUser> userManager, // ⬅ заменено
